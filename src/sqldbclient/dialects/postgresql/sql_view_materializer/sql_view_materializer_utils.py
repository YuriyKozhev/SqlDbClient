...
class SqlViewMaterializerUtils:
    ...
    def set_owner(self) -> None:
        ...
        logger.warning(f'View {self.view.full_name} owner set to {self.view.owner}')
    ...
    def set_privileges(self) -> None:
        for grantee, privileges in self.view.privileges.items():
            for privilege in privileges:
                ...
                """)
        logger.warning(f'View {self.view.full_name} privileges set')
    ...
    def drop(self) -> None:
        if self.view.view_type == ViewType.REGULAR_VIEW:
            ...
            raise Exception('Unexpected error')
        logger.warning(f'View {self.view.full_name} dropped')
    ...
    def create(self) -> None:
        if self.view.view_type == ViewType.REGULAR_VIEW:
            ...
            raise Exception('Unexpected error')
        logger.warning(f'Created {self.view.full_name}')
    ...
    def refresh(self) -> None:
        logger.warning(f'Refreshing {self.view.full_name}...')
        if self.view.view_type == ViewType.REGULAR_VIEW:
            logger.warning(f'Skipping regular view {self.view.full_name}')
        elif self.view.view_type == ViewType.MATERIALIZED_VIEW:
